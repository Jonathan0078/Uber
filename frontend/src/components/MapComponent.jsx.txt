...
const MapComponent = ({ 
  ...
  // Usar coordenadas reais da corrida
  const originCoords = ride && ride.origin_lat && ride.origin_lng ? {
    lat: ride.origin_lat,
    lng: ride.origin_lng
  } : null;
  
  const destinationCoords = ride && ride.destination_lat && ride.destination_lng ? {
