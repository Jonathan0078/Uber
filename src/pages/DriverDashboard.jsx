...
export default function DriverDashboard({ onLogout }) {
  ...
  // useEffect para atualizar a disponibilidade no Firestore quando isAvailable ou driver mudarem
  useEffect(() => {
    if (driver && driver.id) {
  ...
  // useEffect para escutar solicitações de corrida em tempo real
  useEffect(() => {
  ...
  }, [isAvailable, driver, currentRide]);
